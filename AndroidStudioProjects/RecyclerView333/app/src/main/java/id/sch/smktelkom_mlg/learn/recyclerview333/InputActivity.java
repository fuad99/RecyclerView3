package id.sch.smktelkom_mlg.learn.recyclerview333;
...
import id.sch.smktelkom_mlg.learn.recyclerview333.model.Hotel;

public class InputActivity extends AppCompatActivity {

    static final int REQUSET_IMAGE_GET = 1;
    EditText etJudul;
    ...
    private void pickPhoto() {
        ...
        if (intent.resolveActivity(getPackageManager()) != null)
            startActivityForResult(intent, REQUSET_IMAGE_GET);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        if (requestCode == REQUSET_IMAGE_GET && resultCode == RESULT_OK) {
